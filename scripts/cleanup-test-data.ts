 ...
 *
 * Removes all test data based on TEST MARKERS to ensure clean test environment.
 * This script is used by CI burn-in tests and can be run manually.
 *
 ...
 * - Companies: name starts with "Test ", "E2E ", "test_", "e2e_"
 * - Stores: name starts with "Test ", "E2E ", "test_", "e2e_"
 *
