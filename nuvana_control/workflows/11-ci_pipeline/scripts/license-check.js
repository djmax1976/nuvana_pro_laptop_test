...
// Restricted licenses (copyleft, proprietary)
// Note: UNKNOWN removed from restricted list - it's too common and causes false positives
...
try {
  ...
  if (warnings.length > 0) {
    ...
    console.warn('\nThese licenses are not in the approved list. Review manually if needed.');
    console.warn('Note: UNKNOWN licenses are common when npm cannot detect license info from package.json.\n');
  }
