...
/**
 * Create store page
 * Two-step wizard for creating a new store with manager and terminals
 * - If companyId query param is provided, shows wizard directly (Corporate Admin flow)
...
export default function NewStorePage() {
  ...
  // If companyId provided in query, show wizard directly
  if (companyIdFromQuery) {
    return (
      <div className="space-y-6">
        <h1 className="text-2xl font-bold">Create Store</h1>
        <CreateStoreWizard companyId={companyIdFromQuery} />
      </div>
    );
  }
  ...
  // Company selected, show the store wizard
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">Create Store</h1>
      ...
      <CreateStoreWizard companyId={selectedCompanyId} />
    </div>
  );
}
