...
# Listeners
# -----------------------------------------------------------------------------
# HTTP Listener - Redirect to HTTPS if certificate exists, otherwise forward traffic
...
# HTTPS Listener (only if certificate ARN provided)
...
# HTTP listener rule for API (when no certificate)
