...
describe.skipIf(!hasDatabaseUrl)(
  "2.91-UNIT: Client Employee Service - Employee Creation",
  () => {
...
describe.skipIf(!hasDatabaseUrl)(
  "2.91-UNIT: Client Employee Service - Employee Deletion",
  () => {
...
describe.skipIf(!hasDatabaseUrl)(
  "2.91-UNIT: Client Employee Service - Employee Listing",
  () => {
...
describe.skipIf(!hasDatabaseUrl)(
  "2.91-UNIT: Client Employee Service - Store Roles API",
  () => {
