...
describe("Store Activation Validation - Company Status Dependency", () => {
...
describe("Store Activation Validation - Edge Cases", () => {
...
describe("Store Activation Validation - State Transition Matrix", () => {
  /**
